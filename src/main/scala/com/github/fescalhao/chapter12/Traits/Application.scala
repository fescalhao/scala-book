...
import com.github.fescalhao.chapter12.Traits.classes.{BasicIntQueue, Frog, MyQueue, Point, Rational, Rectangle}
import com.github.fescalhao.chapter12.Traits.traits.{Filtering, Incrementing, Philosophical}
